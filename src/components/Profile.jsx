          ...
          return (
            <div
              ...
              style={{
                ...
                borderBottom: item.dividerAfter
            ...
            >
              ...
              <label className="toggle">
                <input
                  ...
                  onChange={() =>
                    setWidgets((p) => ({ ...p, [item.key]: !p[item.key] }))
                  }
                />
...
export default function Profile({ user, onLogout }) {
  ...
  if (subPage === "widgets")
    return <ManageWidgets onBack={() => setSubPage(null)} />;
  ...
  const menuGroups = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          action: () => setSubPage("widgets"),
        },
        {
          icon: <Tag size={18} />,
          label: "Manage Transaction Tags",
          action: () => {},
        },
